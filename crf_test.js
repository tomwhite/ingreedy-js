...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '../crf_test.data';
    var REMOTE_PACKAGE_BASE = 'crf_test.data';
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_../crf_test.data');

    };
    Module['addRunDependency']('datafile_../crf_test.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 4628380, "filename": "/model_file"}, {"start": 4628380, "audio": 0, "end": 4628456, "filename": "/ing.txt"}], "remote_package_size": 4628456, "package_uuid": "717ba696-0378-4171-98fc-bfb01f66882e"});
...
var wasmBinaryFile = 'crf_test.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=27504;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
